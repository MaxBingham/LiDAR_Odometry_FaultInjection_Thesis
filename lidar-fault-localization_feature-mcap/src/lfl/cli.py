...
class CustomHelpFormatter(argparse.HelpFormatter):
    def __init__(self, prog):
        # Breite der gesamten Help-Anzeige = 100, 
        # Einrückung der Beschreibung = 2, Einrückung der Argumente = 4
...
def main():
    ...
    print(json.dumps({"stats": stats, "result_dir": result_dir}), file=sys.stderr)
